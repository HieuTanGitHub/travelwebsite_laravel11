            ...
            <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
                <div class="w100 fl title-tour1">
                    <h2 style="color: #ffc700;font-size: 30px;"><img
                            src="{{ asset('uploads/categories/' . $category_by_slug->image) }}" alt="icon"
                            style="width: 100px;"> {{ $category_by_slug->title }}</h2>
                </div>
            ...
            <div class="col-md-12 col-xs-12 bx-content-lst-tour">
                <div class="row">
                                ...
                                <div class="w100 fl bx-wap-pr-item">
                                    ...
                                    <div class="group-localtion w100 fl">
                                        ...
                                        <div class="col-md-6 col-xs-5 numner-sit">
                                            <span class="lst-icon1"><i class="fa fa-users"></i></span><span> Còn chỗ:
                                                {{ $tour->quantity }}</span>
                                        </div>
                                    </div>
                    ...
                    @else
                        <div class="col-md-12 col-xs-12 bx-content-lst-tour">
                            <div class="row">
                                <h3 style="text-align:center">Hiện tại chưa có tour này,vui lòng xem các tour khác nhé.</h3>
                            </div>
                        </div>
                        <div>
                            {{ $list_tour->render('pagination::bootstrap-4') }}
                        </div>
                    @endif
                </div>
