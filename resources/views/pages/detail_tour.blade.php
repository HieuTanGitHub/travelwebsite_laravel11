    ...
    <div class="container box-container-tour">
        <div class="row">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('chi-tiet-tour', [$tour->slug]) }}">{{ $tour->title }}</a></li>
            </ul>
        </div>
    </div>
    <div class="container box-container-tour">
                                        ...
                                        <div id="animated-thumbnails">
                                            <div id="owl-demo" class="owl-carousel owl-theme owl-demo">
                                                @foreach ($galleries as $key => $gal)
                                                    <div class="item"> <img class="img img-responsive"
                                                            alt="{{ $gal->title }}"
                                                            src="{{ asset('uploads/galleries/' . $gal->image) }}"></div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="col-md-7 col-xs-12 bdesc-dt-right-left">
                                        <table class="table tbct-tour">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: left;">Phương tiện tour: {{ $tour->vehicle }}
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-md-5 col-xs-12 bdesc-dt-right-right">
                                        <div class="bprice-dt-tour">
                                            ...
                                            <div class="clbook-dt span12">
                                                <span class="booknow btn-dattour buy-booking-tour"><img
                                                        alt="{{ $tour->title }}"
                    ...
                    <div class="b-detail-ct-tour w100 fl top-20">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="gallery" class="tab-pane fade">
                                @foreach ($galleries as $key => $gal)
                                    <div class="item"><img class="img img-responsive" alt="{{ $gal->title }}"
                                            src="{{ asset('uploads/galleries/' . $gal->image) }}"></div>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <li>
                                <div class="w100 fl bx-wap-pr-item" style="height: 440px;">
                                    ...
                                    <div class="group-localtion w100 fl">
                                        <div class="col-md-6 col-xs-7 map-maker">
                                            <span class="lst-icon1"><i class="fa fa-map-marker"></i></span><span> Khởi
                                                hành {{ $related->departure_date }}</span>
                                        </div>
                                    ...
                                    <div class="group-book w100 fl">
                                        <span class="price-sell">{{ number_format($related->price, 0, ',', '.') }}
                                            VNĐ</span>
